...
# tab_local.lua - remove "Install a game" contentdb block + prepend theme
ok &= apply(
...
# tab_local.lua - disable the gamebar (only one game will ever be installed)
ok &= apply(
    "builtin/mainmenu/tab_local.lua",
...
# dlg_config_world.lua - remove "Find More Mods" ContentDB button
ok &= apply(
